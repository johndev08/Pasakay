...
<body class="vh-100 content d-flex justify-content-center align-items-center">
    ...
    <div class="border rounded p-5 m-3 w-100 shadow">
        <center>
            <div class="pic border rounded-circle overflow-hidden" style="max-width:100px; max-height:100px;">
                <img src="../Images/pic.png" alt="" style="max-width:100px; max-height:100px;">
            </div>
            <h1 class="mt-3"><?php echo $username; ?></h1>
