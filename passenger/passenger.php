...
<body class="position-relative">
    ...
    $user_grab_query = mysqli_query($connection, "SELECT driver FROM grab WHERE username='$user_username'");
    ?>
        ...
        <div class="tab-pane fade show active" id="pills-East" role="tabpanel" aria-labelledby="pills-East-tab" tabindex="0">
            ...
            <div class="z-1 position-fixed w-100 bottom-0 p-3 d-flex justify-content-end">
                ...
                if (mysqli_num_rows($user_grab_query) > 0) {
                    ...
                    echo "<button class='btn btn-success w-100'><a class='text-decoration-none text-light' href='payment.php'>Grabbed by $driver_name, Proceed to payment</a></button>";
