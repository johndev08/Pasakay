...
$description = "Good day! PASAKAY and we would like to inform you that your registration request as passenger has been approved.";
	//echo '<script>alert("'.$donation.'")</script>';
		$ch = curl_init();
$parameters = array(
...
$description = "Good day! PASAKAY and we would like to inform you that your registration request as passenger has been declined.";
	//echo '<script>alert("'.$donation.'")</script>';
		$ch = curl_init();
$parameters = array(
    'apikey' => 'e9944294311f3a56b5078420508c6a63', //Your API KEY
