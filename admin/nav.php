...
<body>
    ...
    <ul class="nav nav-underline nav-justified py-1 px-2 position-sticky top-0 bg-light shadow">
        ...
        <li class="nav-item">
            <a class="nav-link <?php echo ($currentPage == 'passenger.php') ? 'active border-5 border-primary' : ''; ?>" href="./passenger.php">
                <svg xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 -960 960 960" width="30px" fill="#000000">
        ...
        <li class="nav-item">
            <a class="nav-link <?php echo ($currentPage == 'manageaccount.php') ? 'active border-5 border-primary' : ''; ?>" href="./manageaccount.php">
                <svg xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 -960 960 960" width="30px" fill="#000000">
